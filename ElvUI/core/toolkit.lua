...
while object do
	if not handled[object:GetObjectType()] then --CHANGES:Lanrutcon: removed "not object:IsForbidden() and" from the condition because "IsForbidden" is a MoP function
		addapi(object)
